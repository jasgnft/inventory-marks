...
public class InventoryMarksPlugin extends Plugin {
    ...
    private static final List<String> GROUPS = ImmutableList.of(SETNAME_GROUP_1, SETNAME_GROUP_2, SETNAME_GROUP_3
            , SETNAME_GROUP_4, SETNAME_GROUP_5, SETNAME_GROUP_6);
            ...
            if (w != null && WidgetInfo.TO_GROUP(w.getId()) == WidgetID.INVENTORY_GROUP_ID
                ...
                for (final String groupName : GROUPS) {
                    ...
                    client.createMenuEntry(idx)
                            .setOption(ColorUtil.prependColorTag(groupName, color))
